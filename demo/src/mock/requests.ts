...
const teacherPortalRequests: RequestItem[] = [
  ...
  buildRequest({
    id: 'RQ-20260413-0001B',
    classCode: 'SBO.2026.0316',
    className: 'Movers SBO 0316',
    classMode: 'Lớp 1:1',
    courseName: 'Tiếng Anh Thiếu nhi',
    level: 'Movers',
    ...
    scenarioSummary:
      'Telegram gửi thông báo chuyển ngang và kèm link ERP để giáo viên xác nhận nhận lớp trên hệ thống.',
    status: 'AwaitingConfirmation',
    sourceDepartment: 'CM',
    triggeredBy: 'cm_lananh',
    teacherName: CURRENT_TEACHER.name,
    teacherCode: CURRENT_TEACHER.code,
    teacherType: CURRENT_TEACHER.type,
    teacherPhone: CURRENT_TEACHER.phone,
    ...
    oldTeacherName: 'Lê Thảo Vy',
    oldTeacherCode: 'TV204',
    oldTeacherPhone: '0912333777',
    startDate: '17/04/2026',
    firstSession: '17/04/2026 18:15',
    scheduleSummary: 'Thứ 2 - Thứ 4 - Thứ 6 | 18:15 - 19:45',
    hasPastFirstSession: true,
    deadlineConfirmAt: '16/04/2026 18:15',
    createdAt: '16/04/2026 08:35',
    notifiedAt: '16/04/2026 08:37',
    classStatus: 'Đang học',
    erpActionUrl: buildErpActionUrl('RQ-20260413-0001B', 'pending'),
    noteMessage:
      'Lớp chuyển ngang sang giáo viên mới. Vui lòng vào ERP để xác nhận nhận lớp trước hạn phản hồi.',
    requiresTeacherConfirmation: true,
    events: [
      buildEvent(
        'E-0002B-1',
        ...
        'Tạo yêu cầu',
        'CM',
        'Phát sinh khi đổi giáo viên lớp đang học.',
      ),
      buildEvent(
        'E-0002B-2',
        '16/04/2026 08:37',
        'Gửi thông báo Telegram',
        'Hệ thống',
        `Template: TEACHER_HANDOVER_CONFIRM | ERP link: ${buildErpActionUrl('RQ-20260413-0001B', 'pending')}`,
        { channel: 'Telegram Bot', result: 'Thành công' },
      ),
    ],
  }),
  ...
  buildRequest({
    id: 'RQ-20260413-0004B',
    classCode: 'SBO.2026.0412',
    className: 'Starters SBO 0412',
    classMode: 'Lớp 1:4',
    courseName: 'Tiếng Anh Thiếu nhi',
    level: 'Starters',
    requestType: 'New Opening',
    requestTypeDescription:
      'Tự động phát sinh khi tạo lớp mới ở trạng thái chờ khai giảng hoặc đang học nhưng chưa phát sinh buổi học nào.',
    scenarioSummary:
      'Bản ghi cũ được hủy do vận hành đổi giáo viên khi bản ghi vẫn đang chờ xử lý; giáo viên cũ chỉ xem trong lịch sử.',
    processingStatus: 'Done',
    resolutionResult: 'Cancelled',
    status: 'InformationSent',
    sourceDepartment: 'GVU',
    triggeredBy: 'gvu_hanhnt',
    teacherName: CURRENT_TEACHER.name,
    teacherCode: CURRENT_TEACHER.code,
    teacherType: CURRENT_TEACHER.type,
    teacherPhone: CURRENT_TEACHER.phone,
    ...
    firstSession: '19/04/2026 19:30',
    scheduleSummary: 'Thứ 3 - Thứ 5 | 19:30 - 21:00',
    hasPastFirstSession: false,
    deadlineConfirmAt: '18/04/2026 19:30',
    createdAt: '16/04/2026 09:20',
    notifiedAt: '16/04/2026 09:22',
    closedAt: '16/04/2026 10:05',
    classStatus: 'Chờ khai giảng',
    erpActionUrl: buildErpActionUrl('RQ-20260413-0004B', 'history'),
    noteMessage:
      'Bản ghi đã bị hủy do lớp chuyển sang giáo viên khác trước khi giáo viên phản hồi.',
    requiresTeacherConfirmation: true,
    events: [
      buildEvent(
        'E-0010B-1',
        ...
        'Tạo yêu cầu',
        'GVU',
        'Phát sinh khi mở lớp mới chờ khai giảng.',
      ),
      buildEvent(
        'E-0010B-2',
        '16/04/2026 09:22',
        'Gửi thông báo Telegram',
        'Hệ thống',
        `Template: NEW_OPENING_CONFIRM | ERP link: ${buildErpActionUrl('RQ-20260413-0004B', 'history')}`,
        { channel: 'Telegram Bot', result: 'Thành công' },
      ),
      buildEvent(
        'E-0010B-3',
